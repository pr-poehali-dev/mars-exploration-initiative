...
const faqs = [
  ...
  {
    question: "Что такое Welcome-фуршет?",
    answer: "Welcome-фуршет — это лёгкий приём гостей перед банкетом: напитки и закуски, время познакомиться и пообщаться в непринуждённой обстановке.",
    type: "text",
  },
  {
...
export default function FAQ() {
  ...
  return (
    <div id="faq" className="min-h-screen px-6 py-16 lg:py-24 flex flex-col items-center justify-center" style={{ backgroundColor: '#d6cfc8' }}>
